...
//  backdrop.fillStyle(0x000000, 0.7); // Black color with 70% opacity
  ...
  this.inputElement.style = 'position: absolute; top: 25vh; left: 50; transform: translateX(-50%); font-size: 24px; border: 1px solid black; background: cerulean; color: black;';
