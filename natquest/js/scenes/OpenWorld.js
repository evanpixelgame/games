...
this.sensorHandling = sensorHandler(this, map, this.player, this.sensorID); //used to have this.transitionSensors as an argument
 ...
 console.log('TITI IS SO PRETTY HERES SENSORID OBJECT: ' + gameManager.sensorID);
  }
